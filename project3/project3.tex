...
\[
  \begin{array}{rcl}
  chs_0 &=& \langle [1,2], [\,], [true,9], [\,] \rangle \\[2mm]
  chs_1 &=& \langle [1,2], [\,], [false,9], [\,] \rangle \\[2mm]
    ...
    \der{
      ...
      \subder{
        ...
        \axiom{
          ...
          \Rightarrow \{b \mapsto true^H,\; y \mapsto 9^H\},\, chs_0^2
        }
        \subder{
          \texttt{if}(b)\{\texttt{fscanf}(stdin_{lo},\dots,\&y)\}
          \vdash_p \{b \mapsto true^H,\; y \mapsto 9^H\},\, chs_0^2
          \Rightarrow \{b \mapsto true^H,\; y \mapsto 1^H\},\, chs_0^3
        }{
          \axiom{
            \{b \mapsto true^H,\; y \mapsto 9^H\} \vdash_p b \Downarrow true^H
          }
          \axiom{
            \texttt{fscanf}(stdin_{lo},\dots,\&y)
            \vdash_{p,H} \{b \mapsto true^H,\; y \mapsto 9^H\},\, chs_0^2
            \Rightarrow \{b \mapsto true^H,\; y \mapsto 1^H\},\, chs_0^3
          }
        }
        \axiom{
      ...
      \subder{
        ...
        \axiom{
          ...
          \Rightarrow \{b \mapsto false^H,\; y \mapsto 9^H\},\, chs_1^2
        }
        \subder{
          \texttt{if}(b)\{\texttt{fscanf}(stdin_{lo},\dots,\&y)\}
          \vdash_p \{b \mapsto false^H,\; y \mapsto 9^H\},\, chs_1^2
          \Rightarrow \{b \mapsto false^H,\; y \mapsto 9^H\},\, chs_1^2
        }{
          \axiom{
            \{b \mapsto false^H,\; y \mapsto 9^H\} \vdash_p b \Downarrow false^H
          }
        }
        \axiom{
          \texttt{fscanf}(stdin_{lo},\dots,\&z)
          \vdash_p \{b \mapsto false^H,\; y \mapsto 9^H\},\, chs_1^2
          \Rightarrow \{b \mapsto false^H,\; y \mapsto 9^H,\; z \mapsto 1^L\},\, chs_1^3
        }
        \axiom{
          \texttt{fprintf}(stdout_{lo},\dots,z)
          \vdash_p \{b \mapsto false^H,\; y \mapsto 9^H,\; z \mapsto 1^L\},\, chs_1^3
